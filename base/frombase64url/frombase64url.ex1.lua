...
t.is( frombase64url( "TWFu"), "Man" )
t.is( frombase64url( "bGVhc3VyZS4" ), "leasure." )
t.is( frombase64url( "cGxlYXN1cmUu" ), "pleasure." )
t.is( frombase64url( "ZWFzdXJlLg" ), "easure." )
t.is( frombase64url( "c3VyZS4" ), "sure." )
...
local long64 = "TWFuIGlzIGRpc3Rpbmd1aXNoZWQsIG5vdCBvbmx5IGJ5IGhpcyByZWFzb2"..
               ...
               "bGVhc3VyZS4"
t.is( frombase64url( long64 ), longtxt )
...
t.is( frombase64url( msg64 ), msgtxt )

--ignore characters
t.is( frombase64url( "TW-Fu\n", "-\n" ), "Man" )
